...
Citizen.CreateThread(function()
	...
	for i=1, #Config.Shops, 1 do
		...
		AddTextComponentString('<font face="font4thai">ร้านตัดผม</font>')
...
Citizen.CreateThread(function()
	while true do
		...
		local coords = GetEntityCoords(PlayerPedId(-1)), true
...
Citizen.CreateThread(function()
	while true do
		...
		if CurrentAction ~= nil then
			exports["Simple_TextUI"]:ShowHelpNotification("Press ~INPUT_CONTEXT~ To Barber")
